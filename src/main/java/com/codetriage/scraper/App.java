      ...
      int cont = 1;
        for (int i = 0; i <= 100; i = i + 25) {
            try {
                ...
                Document doc = Jsoup //
                        .connect("https://www.linkedin.com/jobs/search/?distance=10&geoId=104746682&keywords=java&location=S%C3%A3o%20Paulo%2C%20S%C3%A3o%20Paulo%2C%20Brasil&start=" + i)
